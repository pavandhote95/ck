                ...
                child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: [
                                                ...
                                                children: [
                                                    ...
                                                    if (lines.length > 4)
                                                        TextSpan(
                                                            text: isExpanded ? '\nShow Less' : '\nShow More',
                                                            style: GoogleFonts.montserrat(
                                                                fontSize: 16, color: Colors.tealAccent, fontWeight: FontWeight.w600),
                            ...
                            // Likes & comment icons row (no animation for performance)
                            Row(
                                children: [
                                    const Icon(Icons.favorite_border, color: Colors.white),
                                    const SizedBox(width: 8),
                                    Text('${post.likes} Likes', style: GoogleFonts.montserrat(color: Colors.white)),
                            ...
                            // ✅ Animate Comment Preview block only
                            Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
